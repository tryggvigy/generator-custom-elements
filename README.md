# generator-custom-elements [![Build Status](https://secure.travis-ci.org/tryggvigy/generator-custom-elements.png?branch=master)](https://travis-ci.org/tryggvigy/generator-custom-elements)
